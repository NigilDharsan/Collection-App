class CustomerAccountModel {
  ...
  CustomerAccountModel({this.message, this.data});
  ...
  CustomerAccountModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(new CustomerAccountData.fromJson(v));
      });
    }
  }
...
class CustomerAccountData {
  ...
  CustomerAccountData.fromJson(Map<String, dynamic> json) {
    ...
    lastPaidAmount = json['last_paid_amount'] != null
        ? json['last_paid_amount'] == ""
            ? 0.0
            : json['last_paid_amount'].toDouble()
        : 0.0;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['next_due_on'] = this.nextDueOn;
